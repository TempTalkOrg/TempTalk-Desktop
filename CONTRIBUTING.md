...
You can check [`.nvmrc` in the `development` branch](https://github.com/TempTalkOrg/TempTalk-Desktop/blob/development/.nvmrc) to see what the current version is. If you have [nvm](https://github.com/creationix/nvm)
...
You can setup additional storage profiles and switch
...
`local-development.json` in the `config` directory.
