import type { ParticipantPermission } from '@cc-livekit/protocol';
import {
  Participant,
  RemoteParticipant,
  Room,
...
import { ParticipantEvent, RoomEvent, Track } from '@cc-livekit/livekit-client';
// @ts-ignore some module resolutions (other than 'node') choke on this
import type { ParticipantEventCallbacks } from '@cc-livekit/livekit-client/dist/src/room/participant/Participant';
