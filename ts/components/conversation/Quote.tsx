...
export class Quote extends React.Component<Props, State> {
  ...
  public renderGenericFile() {
    ...
    return (
      <div className="module-quote__generic-file">
        ...
        >
          {messageMode ? i18n('confidential-message-description') : fileName}
        </div>
      </div>
    );
  }
  ...
  public renderIconContainer() {
    ...
    const { contentType, thumbnail, isVoiceMessage } = attachment;
    ...
    if (MIME.isAudio(contentType)) {
      return isVoiceMessage
        ? this.renderIcon('voice')
        : this.renderIcon('microphone');
    }
