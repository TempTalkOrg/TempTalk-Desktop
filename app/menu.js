...
const { recordContentTracing } = require('../ts/perf/contentTracing');
...
function updateForMac(template, messages, options) {
  ...
  template.unshift({
    ...
    submenu: [
      ...
      {
        label: messages.appMenuCheckForUpdates.message + channelSuffix,
