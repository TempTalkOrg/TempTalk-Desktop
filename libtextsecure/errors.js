...
(function () {
  ...
  function OutgoingMessageError(number, message, timestamp, httpError) {
    ...
    ReplayableError.call(this, {
      ...
      message: httpError ? httpError.message : message || 'no http error',
    });
  ...
  function ForbiddenUserError(number, httpError) {
    this.message = httpError.message;
  ...
  inherit(Error, ForbiddenUserError);

  function UnavailableUserError(number) {
    this.message = 'The user was unavailable when the message was sent.';
  ...
  inherit(Error, UnavailableUserError);

  window.textsecure.UnavailableUserError = UnavailableUserError;
  window.textsecure.ForbiddenUserError = ForbiddenUserError;
