...
module.exports = grunt => {
    ...
    concat: {
      ...
      libtextsecure: {
        ...
        src: [
          ...
          'libtextsecure/new_session_cipher.js',
          ...
          'libtextsecure/outer_request.js',
          'libtextsecure/send_call.js',
          'libtextsecure/outgoing_call.js',
        ],
      ...
      libtextsecuretest: {
        src: [
          ...
          'js/jquery-migrate/jquery-migrate.js',
  ...
  grunt.registerTask('getExpireTime', () => {
    ...
    const time = Date.parse(commited) + 1000 * 60 * 60 * 24 * 365 * 5;
